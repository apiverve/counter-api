...
/**
 * Client for the Cloud Counter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/counter?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/counter';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CounterClient] {$message}\n";
        }
    }
}
