...
```gradle
dependencies {
    implementation 'com.github.apiverve:counter-api:1.1.13'
}
```
...
```java
import com.apiverve.counter.CloudCounterAPIClient;
import com.apiverve.counter.APIResponse;
import com.apiverve.counter.APIException;

// Initialize the client
CloudCounterAPIClient client = new CloudCounterAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("id", "test_counter");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/counter](https://docs.apiverve.com/ref/counter)
...
- **Documentation:** [https://docs.apiverve.com/ref/counter](https://docs.apiverve.com/ref/counter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/counter-api/issues)
