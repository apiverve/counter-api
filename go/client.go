// Package counter provides a Go client for the Cloud Counter API.
//
// For more information, visit: https://apiverve.com/marketplace/counter?utm_source=go&utm_medium=readme
package counter
...
const (
	baseURL        = "https://api.apiverve.com/v1/counter"
	defaultTimeout = 30 * time.Second
)

// Client is the Cloud Counter API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Cloud Counter API client.
...
// Execute makes a request to the Cloud Counter API with typed parameters.
//
...
//   - id (required): string - The ID of the counter (e.g., test_counter)
