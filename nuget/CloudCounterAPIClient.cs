...
namespace APIVerve.API.CloudCounter
{
    ...
    /// <summary>
    /// Client for the CloudCounter API
    /// </summary>
    public class CloudCounterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/counter";
        ...
        {
            { "id", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public CloudCounterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CloudCounterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CloudCounterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CloudCounterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CloudCounterQueryOptions options)
        {
        ...
        public ResponseObj Execute(CloudCounterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CloudCounterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CloudCounterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CloudCounterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CloudCounterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CloudCounterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CloudCounterQueryOptions options)
        {
